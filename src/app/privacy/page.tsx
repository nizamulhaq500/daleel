...
export default function PrivacyPolicyPage() {
  return (
    <main className="min-h-screen bg-[#020617] text-slate-50 relative overflow-hidden selection:bg-emerald-500/30 selection:text-emerald-200">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-16 relative z-10">
        ...
        <div className="mb-10">
          <Link 
            href="/" 
            className="inline-flex items-center gap-2 text-sm font-semibold text-slate-400 hover:text-emerald-400 transition-colors bg-slate-900/80 hover:bg-slate-800/80 border border-slate-800 hover:border-emerald-500/30 px-4 py-2.5 rounded-xl shadow-lg backdrop-blur-md"
          >
        ...
        <div className="border-b border-slate-800 pb-8 mb-12">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mt-1">
                Privacy Policy
              </h1>
            </div>
          </div>
        ...
        <div className="bg-emerald-950/30 border border-emerald-800/60 rounded-2xl p-5 md:p-6 mb-12 flex items-start gap-4 shadow-xl">
          <AlertCircle className="w-6 h-6 text-emerald-400 shrink-0 mt-0.5" />
          <div className="text-sm text-slate-300 leading-relaxed">
            <strong className="text-white block font-semibold mb-1">Our Core Commitment: Zero Monetization & Data Minimization</strong>
        ...
        <div className="space-y-10">
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-emerald-500/10 rounded-lg text-emerald-400">
                <FileText className="w-5 h-5" />
              </div>
              <h2 className="text-xl md:text-2xl font-bold text-white">1. Data Collection</h2>
            </div>
            ...
            <ul className="space-y-3 text-slate-300 text-sm list-disc pl-5">
              <li>
                <strong className="text-slate-100">Account Credentials:</strong> When you register via Google OAuth or Email/Password, we collect your name, email address, and profile photo.
              </li>
              <li>
                <strong className="text-slate-100">Incident Evidence & Reports:</strong> When you report hate speech, we collect the submitted text snippets, source social media URLs, timestamp metadata, and uploaded screenshots or images.
              </li>
              <li>
                <strong className="text-slate-100">Anonymous Reports:</strong> Community reporters may opt to submit incidents anonymously, in which case no personal identity is linked to the evidence payload.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">2. Data Storage & Security</h2>
            </div>
            <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <ul className="space-y-3 text-slate-300 text-sm list-disc pl-5">
              <li>
                <strong className="text-slate-100">Storage Infrastructure:</strong> Data is hosted securely on Google Cloud Firebase (Cloud Firestore & Firebase Storage) with AES-256 encryption at rest and TLS 1.3 encryption in transit.
              </li>
              <li>
                <strong className="text-slate-100">Granular Access Control:</strong> Access to evidence dossiers is strictly governed by role-based Firestore security rules, ensuring only authenticated reporters, journalists, and authorized officials view relevant data tiers.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">3. Data Sharing & Pipeline Routing</h2>
            </div>
            <p className="text-slate-300 leading-relaxed mb-4">
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">4. Data Retention</h2>
            </div>
            <ul className="space-y-3 text-slate-300 text-sm list-disc pl-5">
              <li>
                <strong className="text-slate-100">Incident Reports:</strong> Raw unverified incident submissions and evidence records are retained for a maximum of <strong>90 days</strong> in the active queue, after which unescalated records are permanently purged.
              </li>
              <li>
                <strong className="text-slate-100">User Accounts:</strong> Account profiles and preferences are retained for as long as your account remains active or until you request account deletion.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">5. Your Rights & Data Control</h2>
            </div>
            <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <ul className="space-y-3 text-slate-300 text-sm list-disc pl-5">
              <li>
                <strong className="text-slate-100">Access & Export:</strong> You can request a complete JSON or PDF export of all your submitted reports and profile history.
              </li>
              <li>
                <strong className="text-slate-100">Right to Erasure (Deletion):</strong> You can delete specific reports or permanently delete your entire account through the application settings (<span className="text-emerald-400 font-mono">Settings &gt; Data &amp; Privacy</span>) or by emailing us directly.
              </li>
            </ul>
          </section>
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">6. Cookies & Tracking Technologies</h2>
            </div>
          ...
          <section className="bg-slate-900/60 border border-slate-800/80 rounded-2xl p-6 md:p-8 backdrop-blur-md shadow-lg hover:border-slate-700/80 transition-colors">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl md:text-2xl font-bold text-white">7. Contact Information</h2>
            </div>
            ...
            <div className="bg-slate-950/80 border border-slate-800 p-4 rounded-xl inline-flex items-center gap-3">
              <Mail className="w-5 h-5 text-emerald-400" />
              <a 
                href="mailto:daleel.project@gmail.com" 
                className="text-emerald-400 font-mono text-sm hover:underline"
              >
                daleel.project@gmail.com
              </a>
            </div>
          </section>
